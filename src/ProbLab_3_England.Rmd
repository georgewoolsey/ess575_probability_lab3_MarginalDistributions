...
\textcolor{blue}{Interpret the results ecologically }
...
\textcolor{blue}{If the rates were not correlated ... }
...
ggplot(data = dta) + 
  geom_histogram(aes(return_rate), fill = "transparent", lwd = 1, color = "black", alpha = 0.7) +
  xlab("Rate of Return") +
  theme_bw()
# inflation rate distribution
ggplot(data = dta) + 
  geom_histogram(aes(inflation_rate), fill = "transparent", lwd = 1, color = "black", alpha = 0.7) +
